...
openssl x509 -req -days 365 -extfile ./config/IntermediateCA.cfg -extensions v3_intermediate_ca -in IntermediateCA.csr -CA RootCA.crt -CAkey RootCA.key -passin pass:PwdRootCA -out IntermediateCA.crt
...
openssl x509 -req -days 365 -extfile ./config/mypage.com.cfg -extensions v3_server_cert -in mypage.com.csr -CA IntermediateCA.crt -CAkey IntermediateCA.key -passin pass:PwdIntermediateCA -out mypage.com.crt
